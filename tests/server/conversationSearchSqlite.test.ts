...
let serviceModule: Awaited<typeof import('../../server/services/conversationService.ts')> | null = null
...
if (sqliteAvailable) {
  ...
  serviceModule = await import('../../server/services/conversationService.ts')
