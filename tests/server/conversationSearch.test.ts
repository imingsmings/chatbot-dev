...
} = await import('../../server/services/conversationService.ts')
const { searchConversations } = await import('../../server/controllers/conversationController.ts')
const conversationRouter = (await import('../../server/routes/conversations.ts')).default
const { appendMessages } = await import('../../server/utils/conversationStore.ts')
