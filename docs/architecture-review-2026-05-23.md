...
> 历史快照：本文保留 2026-05-23 当时的实现与审查结论，包含已移除的 Vue 路径和旧测试命令。当前架构、协议和测试入口分别以 [架构](architecture.md)、[流式协议](streaming-protocol.md)和[回归测试矩阵](regression-test-cases.md)为准。
